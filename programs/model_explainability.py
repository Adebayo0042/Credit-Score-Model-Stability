...
def sensitivity_analysis():
    ...
    stable_classifiers = model_dev.classifiers["HistGradientBoosting"]
    ...
    titles = ['Hist-GradientBoosting Sensitivity Index']
    ...
    st.info("Hist-Gradient Boosting Classifier Model Explanation: Highlighting Contributions of Features to Model Output Variance")
    print("---------------------------------------------------------------------------------------------------------------------")
...
def shap_explaination():
    ...
    ## Model Explanability
    model_histGB_clf = model_dev.classifiers['HistGradientBoosting']
    ...
    explainer = shap.Explainer(model_histGB_clf.predict,X_train_shap)
